...
<button onclick="location.href='menu.php'" class="button3" type="button">VER MEN&Uacute; HOY</button><button onclick="location.href='menu.php'" class="button1" style="background-color: #37B143; left:35%;position: relative" type="button">PEDIR AHORA</button><!----------------------------------- Content 2: Las más vendidos --------------------------->
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Project5\resources\views/aboutus.blade.php ENDPATH**/ ?>