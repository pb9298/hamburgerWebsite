...
<a href="<?php echo e(url('menu')); ?>"><button class="button1" type="button" href="<?php echo e(url('menu')); ?>">VER MENÚ HOY</button></a><a href="<?php echo e(url('menu')); ?>"><button class="button1" type="button" href="<?php echo e(url('menu')); ?>">PEDIR AHORA</button></a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/Project5_latest/resources/views/aboutus.blade.php ENDPATH**/ ?>